...
public class ConfigurationReaderTest {
    ...
    public void test_ReadConfiguration_no_file() throws Exception {
        when(systemInformation.getConfigFolder()).thenReturn(temporaryFolder.getRoot());
        ConfigurationReader configurationReader = new ConfigurationReader(systemInformation);
        configurationReader.readConfiguration();
    }

    @Test
    public void test_successfully_read_config() throws Exception {
        configurationReader = new ConfigurationReader(systemInformation);
        when(systemInformation.getConfigFolder()).thenReturn(temporaryFolder.getRoot());
